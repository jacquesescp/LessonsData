...
def path_to_data_folder():
    return "/Users/yourusername/Documents/python/finance-courses/data/" 

def get_ind_returns():

    try:
        ind = pd.read_csv("data_ind30_m_vw_rets.csv", header=0, index_col=0,
...
def get_ffme_returns():
    ...
    '''
    filepath = path_to_data_folder() + "data_Portfolios_Formed_on_ME_monthly_EW.csv"
...
def get_hfi_returns():
    ...
    '''
    filepath = path_to_data_folder() + "data_edhec-hedgefundindices.csv"
...
def get_fff_returns():
    ...
    '''
    filepath = "data_F-F_Research_Data_Factors_m.csv"
...
def get_ind_file(filetype="rets", nind=30, ew=False):
    ...
    filepath = "data_ind{}_m_{}.csv" .format(nind, name)
